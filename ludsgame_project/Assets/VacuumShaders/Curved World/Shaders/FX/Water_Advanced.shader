...
CGINCLUDE  
	...
	#include "../cginc/CurvedWorld_Water.cginc"
	...
	half4 frag300( v2f_noGrab i ) : SV_Target
	{
		...
		half4 baseColor = lerp (_BaseColor, _ReflectionColor, saturate(refl2Refr * 2.0));
...
Subshader
{
	...
	Pass 
	{
			...
			#pragma shader_feature WATER_VERTEX_DISPLACEMENT_ON WATER_VERTEX_DISPLACEMENT_OFF
			#pragma shader_feature WATER_EDGEBLEND_ON WATER_EDGEBLEND_OFF
